...
/**
 * This class is an implementation of the BotStrategy interface
 * for using a high risk bot strategy
 * 
 * @author Eugene Chua
 */
public class HighRiskStrategy implements BotStrategy {
	 ...
	 * only holds if score is at least 19
	 * 
	...
	/**
	 * Makes random bet from 50 to 100 (inclusive)
